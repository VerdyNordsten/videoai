...
export default function Header({ sidebarOpen, setSidebarOpen }: { sidebarOpen: boolean; setSidebarOpen: (open: boolean) => void; }) {
  ...
  return (
    <header id="header" className={`fixed top-0 ${sidebarOpen ? 'left-0 md:left-64' : 'left-0'} right-0 bg-white border-b border-gray-200 z-30 transition-all duration-300 md:left-64`}>
      <div className="flex items-center justify-between px-4 md:px-6 py-3 md:py-4">
        <div className="flex items-center space-x-3 md:space-x-4">
          ...
          <h1 className="font-poppins font-semibold text-xl md:text-2xl text-gray-900">Dashboard</h1>
        ...
        <div className="flex items-center space-x-3 md:space-x-4">
          <div className="relative hidden sm:block">
            <input 
              ...
              className="w-48 md:w-80 pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-sm md:text-base"
              value={searchQuery}
          ...
          <button className="p-2 text-muted hover:text-gray-900 transition-colors hidden sm:block">
          ...
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            <i className="fa-solid fa-chevron-down text-muted hidden md:block"></i>
          </div>
        </div>
      </div>

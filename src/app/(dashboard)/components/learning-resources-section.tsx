    ...
    <section id="learning-section" className="mb-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-muted text-sm">Master video marketing with our tutorials and guides</p>
        </div>
        <button className="text-primary font-medium hover:underline text-sm">View All Resources</button>
      </div>

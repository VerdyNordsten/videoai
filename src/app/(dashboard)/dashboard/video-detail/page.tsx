...
// This is a server component that will receive videoData as a prop
export default function VideoDetailPage({ videoData }: { videoData: typeof videoAnalysisData[number] }) {
  return (

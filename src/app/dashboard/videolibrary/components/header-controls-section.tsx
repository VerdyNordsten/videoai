        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex flex-col sm:flex-row gap-3 flex-1">
            ...
            <div className="flex gap-2">
              <select className="px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary">
          ...
          <button className="bg-primary text-white font-medium px-4 py-2.5 rounded-xl btn-hover flex items-center justify-center">

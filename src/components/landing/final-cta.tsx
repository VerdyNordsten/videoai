    ...
    <section className="py-20 bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          ...
          <Button variant="outline" className="border-2 border-gray-300 text-gray-700 hover:bg-gray-100 px-8 py-6 rounded-full font-semibold text-lg">
            <FaCalendar className="mr-2 h-5 w-5" /> Book a Demo
          </Button>
        </div>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          <Button variant="ghost" className="text-gray-700 hover:bg-gray-100 px-8 py-6 rounded-full font-semibold text-lg">
